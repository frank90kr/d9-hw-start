  ...
  switch (action.type) {
    ...
    case "ADD_TO_FAVOURITES":
      return {
        ...
        // al di fuori di cart
        preferiti: {
          ...state.preferiti, // di nuovo riparto dal cart di prima, per evitare di perdere altre potenziali proprietà
          // di questo sotto-oggetto...
          content: state.preferiti.content.concat(action.payload),
